...
RSpec.configure do |c|
  ...
  c.before :suite do
    ...
    hosts.each do |host|
      ...
      puppet_module_install(:source => project_root, :module_name => 'manage_ebs_crossaz')
...
def upload_hiera_yaml( hiera_content, calling_module='manage_ebs_crossaz' )
...
def set_hieradata( hieradata_hash, calling_module='manage_ebs_crossaz' )
